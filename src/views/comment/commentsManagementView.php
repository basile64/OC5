            ...
            <div class="comment-container">
                ...
                <div class="right-comment-list">
                    ...
                    <div class="icons">
                        ...
                        <a href="/OC5/admin/commentsManagement/approve/<?= htmlspecialchars($comment->getCommentId()) ?>" style="background-color:green"><img class="svg" src="http://localhost/OC5/public/svg/check.svg"/></a>
                        <a href="/OC5/admin/commentsManagement/delete/<?= htmlspecialchars($comment->getCommentId()) ?>" style="background-color:#de0404"><img class="svg" src="http://localhost/OC5/public/svg/close.svg"/></a>
                    </div>               
                </div>
            </div>
        </div>
