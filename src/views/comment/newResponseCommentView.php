...
<form class="new-response-comment-container hidden" id="comment<?= htmlspecialchars($mainComment->getMainCommentId()) ?>" method="post" action="http://localhost/OC5/responseComment/create">
