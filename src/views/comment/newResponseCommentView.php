...
<form class="new-response-comment-container hidden" id="comment<?= htmlspecialchars($mainComment->getMainCommentId()) ?>" method="post" action="<?= htmlspecialchars(BASE_URL) ?>responseComment/create">
