        ...
        <div class="user-container-list">
            <div class="user-container">
                ...
                <div class="right-user-list">
                    ...
                    <a href="/OC5/user/<?= $user->getId() ?>"><img class="svg" src="http://localhost/OC5/public/img/arrow-up.svg"/></a>
                    <a href="/OC5/admin/usersManagement/delete/<?= $user->getId() ?>" style="background-color:#de0404"><img class="svg" src="http://localhost/OC5/public/img/trash.svg"/></a>
                    <a href="/OC5/admin/usersManagement/edit/<?= $user->getId() ?>" style="background-color:#2020cf"><img class="svg" src="http://localhost/OC5/public/img/pencil.svg"/></a>
                </div>
             </div>
        </div>
    <?php } ?>
